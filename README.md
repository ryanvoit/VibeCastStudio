...
Как только, Вы сможете авторизироваться, Вы попадете на главную страницу, передвами откроется список композиций. При нажатии на какую-либо композицию, откроется плэйер и композиция начнет играть. Также в списке Вы сможете жобавлять композицию в избранное нажав на сердечко, увидеть длительность композиции. Также на странице реализована пагинация. Помимо этого есть поле поиска, с помощью которого Вы можете найти композицию по названию. Если Вы нажмете на кнопку, где прописан Ваш username, то Вы выйдете из аккаунта.
